        ...
        case 0x33: // Op           0b0110011
        {
          ...
          if (is_reg && (ir & 0x02000000)) {
            ...
            case 0:
              rval = rs1 * rs2;
              break; // MUL
#ifndef CUSTOM_MULH  // If compiling on a system that doesn't natively, or via
                     // libgcc support 64-bit math.
            case 1:
            ...
            case 4:
              ...
              break;
            case 5:
              rval = (ir & 0x40000000) ? (((int32_t)rs1) >> (rs2 & 0x1F))
                                       : (rs1 >> (rs2 & 0x1F));
              break;
            case 6:
              rval = rs1 | rs2;
            ...
            if (((csrno & 0xff) == 0x02)) // MRET
            {
              ...
              case 0:
                trap =
                    (CSR(extraflags) & 3)
                        ? (11 + 1)
                        : (8 + 1); // ECALL; 8 = "Environment call from U-mode";
